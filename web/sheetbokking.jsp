...
@media screen and (max-width: 800px) {
    ...
    <body>
        ...
        <form id="booking_tickets" name="booking_tickets" action="Config_Booking" method="POST">
            ...
            <div class="seattable_container">
                <div class="row">
                    <p style="border: 1px solid black; margin: 4px; flex: 50%; background-color: #361414; color: white; padding: 12px 16px; text-align: center">Full Ticket Price = 8 $</p>
                    <p style="border: 1px solid black; margin: 4px; flex: 50%; background-color: #361414; color: white; padding: 12px 16px; text-align: center">Kid Ticket Price = 5 $</p>
                </div>
                <table id="seat_table">
                    <tr>
                        <th></th>
 ...
 <div class="footer">
    ...
    var fullval = parseInt(fullTickets.value)*8;
    var halfval = parseInt(kidTickets.value)*5;
